...
public class ShelfInfo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        ShelfInfo other = (ShelfInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getMerchantId() == null ? other.getMerchantId() == null : this.getMerchantId().equals(other.getMerchantId()))
            && (this.getShelfName() == null ? other.getShelfName() == null : this.getShelfName().equals(other.getShelfName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShelfName() == null) ? 0 : getShelfName().hashCode());

...
public class OrderDetail implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDishNum() == null ? other.getDishNum() == null : this.getDishNum().equals(other.getDishNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDishNum() == null) ? 0 : getDishNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", dishNum=").append(dishNum);
